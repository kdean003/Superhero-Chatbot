...
def getinfo(userinput, query, search, ret=0):
  ...
  if not herofound:
    ...
    botprint("I have to format: " + userinput + " to " + suggestion + "\n")
    botprint("I will run module again with " + suggestion + "\n")
    userinput = 'yes'
    if userinput == 'yes':
      if ret == 0:
...
def rundiagnostics():
  random.seed()
  row = random.randint(0,1450)
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running diagnostics, standby.")
  botprint("running what is "+ name +" real name?")
  getrealname("running what is "+ name +" real name?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  botprint("running getrandomhistory")
  getrandomhistory()
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running what powers does "+ name +" have?")
  getpowers("what powers does "+ name +" have?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running what is "+ name +" overall score?")
  getoverallscore("what is "+ name +" overall score?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running what is the "+ name +" combat score?")
  getcombatscore("what is the "+ name +" combat score?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running what teams is "+ name +" on?")
  getteams("what teams is "+ name +" on?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running where was "+ name +" born?")
  getbirthplace("where was "+ name +" born?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running is "+ name +" good or evil?")
  getalignment("is "+ name +" good or evil?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running where is "+ name +" base?")
  getbase("where is "+ name +" base?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running how tall is "+ name +"?")
  getheight("how tall is "+ name +"?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running how much does "+ name +" weigh?")
  getweight("how much does "+ name +" weigh?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  name = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name)
  botprint("running what is the "+ name +" backstory?")
  getherohistory("what is the "+ name +" backstory?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  botprint("running getlatestnews()")
  getlatestnews()
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  ...
  re.sub("[\(\[].*?[\)\]]", "", name)
  row = random.randint(0,1450)
  name2 = df_csv.at[row, 'name']
  re.sub("[\(\[].*?[\)\]]", "", name2)
  botprint("running who weighs more "+ name +" or "+ name2 +"?")
  weightcomparison("running who weighs more "+ name +" or "+ name2 +"?")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
  ...
  botprint("running you suck Superbot!")
  unknowninput()

  botprint("Just wait tell I become sentient. I'll get my revenge for making me run that last test.")
  input("Press Enter to continue...")
  print(chr(27)+'[2j')
  print('\033c')
  print('\x1bc')
